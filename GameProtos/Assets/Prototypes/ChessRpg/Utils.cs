...
public class Utils 
{
   public static List<Vector2> GetStep(int row,int col, MOV_TYPE type)
    {
        ...
        if (type== MOV_TYPE.MOV_I)
        {
            ...
            Vector2 v_up = new Vector2(row, col + 1);
            Vector2 v_down = new Vector2(row, col - 1);
            Vector2 v_left = new Vector2(row - 1, col);
            Vector2 v_right = new Vector2(row +1, col);
        ...
        {
            Vector2 left_top = new Vector2(row - 1, col + 1);
            Vector2 left_bot = new Vector2(row - 1, col - 1);
            Vector2 right_top = new Vector2(row + 1, col + 1);
            Vector2 right_bot = new Vector2(row + 1, col - 1);
        ...
        {
            Vector2 v_up_l = new Vector2(row-1, col + 2);
            Vector2 v_up_r = new Vector2(row + 1, col + 2);

            Vector2 v_down_l = new Vector2(row - 1, col - 2);
            Vector2 v_down_r = new Vector2(row + 1, col - 2);

            Vector2 v_left_u = new Vector2(row - 2, col +1);
            Vector2 v_left_d = new Vector2(row - 2, col - 1);

            Vector2 v_right_u = new Vector2(row + 2, col + 1);
            Vector2 v_right_d = new Vector2(row + 2, col - 1);
